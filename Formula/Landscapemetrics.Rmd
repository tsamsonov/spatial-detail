...
Диаграммы размаха (Рис. \@ref(fig:densboxnorm)) демонстрируют существенно более компактный интерквартильный размах, при этом медианные значения остаются практически не смещенными, что позволяет говорить о более качественной разделимости уровней детализации после выполненного преобразования данных. Это подтверждается статистически результатами теста Стьюдента на равенство средних, приведенными в Таблице \@ref(tab:abs-pvalues-norm): p-значения для всех масштабных переходов имеют величину ниже 0.005, что существенно лучше, чем аналогичые результаты, полученные для исходных, не преобразованных данных. Таким образом, можно утверждать, что разработанный нами подход позволяет учесть неравномерность хозяйственного освоения территории при оценке детализации картографических данных.
