...
где $d_i$ — величина $i$-й метрики детализации, $u$ — доля урбанизированных территорий, $с$ — доля сельскохозяйственных угодий. Результаты регрессионного анализа приведены в Таблице \@ref(tab:coef).
